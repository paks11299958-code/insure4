    ...
    <main className="min-h-screen bg-[#2c2a29] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-medium text-[#f0ebe0] mb-1">회원가입</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white/[0.03] border border-[#d4b483]/20 rounded-2xl p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs text-[#d4b483] font-medium">비밀번호 <span className="text-[#7a7060] font-normal">(6자 이상)</span></label>
          ...
          <p className="text-center text-xs text-[#7a7060]">
            이미 계정이 있으신가요?{' '}
            <Link href="/login" className="text-[#d4b483] hover:underline">로그인</Link>
          </p>
        </form>
      </div>
    </main>
